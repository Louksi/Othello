...
\begin{frame}
  ...
  Othello (ou Reversi) (Othello est une marque déposée) se joue à deux joueurs, sur un plateau carré de 8x8 à 12x12 cases.\\
...
\begin{frame}
  \frametitle{Explication du sujet - Structures de données}
    + stockage des bitboards dans des tuples \\
    + stockage des tuples moovs joués + état du board dans une queue \\
    + fichiers de sauvegarde en ASCII
\end{frame}
