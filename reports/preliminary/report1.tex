...
\subsubsection{Besoins fonctionnels}
  ...
  \paragraph{F16. Aide en ligne de commande:}
  \begin{itemize}
    \item
  \end{itemize}


  \paragraph{F17. Version:}
  \begin{itemize}
    \item
  \end{itemize}
...
%Décrire ce que le système doit faire (par exemple : gestion des utilisateurs, génération de rapports, etc.).

%\subsection{Besoins non fonctionnels}
%Lister les exigences telles que les performances, la sécurité, l'évolutivité.
