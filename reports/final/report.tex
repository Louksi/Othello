...
\texttt{Alpha-Beta} est mieux adapté à nos besoins.\\
 ...
 \begin{figure}[h]
     \centering
     \includegraphics[width=0.9\textwidth]{images/algoritm_time_comparison.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/heuristic_comparison_depth.png}
    \caption{TFigure 2: Minimax vs Alpha-Beta à profondeur 8.}
    \title{fig:heuristic_comparison_depth.png}
\end{figure}

Par ailleurs, une question cruciale a été
