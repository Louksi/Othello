...
Le contrôlleur se place donc en homme du milieu entre les vues et les modèles. De fait, nous avons implémentés une architecture Model-View-Presenter.
...
%     \centering
%     \includegraphics[width=0.9\textwidth]{images/perfs_tps_calcul.png}
%     \caption{Temps de calcul par tour pour une configuration donnée.}
%     \title{fig:tps_calcul_par_tour.png}
...
%     \centering
%     \includegraphics[width=0.9\textwidth]{images/perfs_m_vs_ab_p8.png}
%     \caption{TFigure 2: Minimax vs Alpha-Beta à profondeur 8.}
%     \title{fig:perfs_m_vs_ab_p8.png}
...
la profondeur de recherche. Par ailleurs, une question cruciale a été
investiguée : Othello présente-t-il un biais en fonction du côté (noir/blanc)
avec lequel on débute ?\\ Pour y répondre, des tests ont été menés avec
\texttt{coin\_parity} à une profondeur de 6, permettant de collecter des
données statistiques sur les taux de victoire. En effet, environ 52\% du temps
le deuxième joueur gagne, c’est dû au fait qu'il posera la dernière pièce en
cas d’un tableau rempli.\\
