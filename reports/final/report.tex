...
\begin{lstlisting}[caption={Pseeudocode pour l'initialisation des bitboards : classe BitboardProperties}, label={lst:bitboard_properties}]
...
Ces deux algorithmes utilisent nos 4 heuristiques implémentées, décrites en
